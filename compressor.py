...
def do_compression(filename, do_merge=False):
    ...
    uncompressed_img_size = round((os.stat(filepath).st_size / 1024**2), 4)
    compressed_img_size = round((os.stat(compressed_filepath).st_size / 1024**2), 4)
